...
public class MailBox extends BasicComponent {

	public MailBox(BasicComponent comp) {
		super(comp);
	}
	public MailBox(String cName, String iName, String ver,
	...
	public DTNode toDTNode(BoardInfo bi,Connection conn)
	{
		...
		n.addProperty(new DTProperty("linux,mailbox-name", getInstanceName()));
		return n;
	}
}
