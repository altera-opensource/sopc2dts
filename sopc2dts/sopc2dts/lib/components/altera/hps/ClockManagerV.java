			...
			cmPLLs = new ClockManagerPll[]{
					...
					new ClockManagerPll("main_pll", 0x40, 
							...
							new ClockManagerPClk[] {
									...
									new ClockManagerPClk("dbg_base_clk",	0x10, new Long(4), null),
									new ClockManagerPClk("mpuclk",			0x08, new Long(2), null),
									new ClockManagerPClk("mainclk",			0x0C, new Long(4), null),
