...
public class Sopc2DTS {
	...
	public Sopc2DTS() {
		...
		vOptions.add(new CommandLineOption("type", 		"t", outputType, 		true, false,"The type of output to generate", "{dtb,dtb-hex8,dtb-hex32,dtb-char-arr,dts,uboot,kernel,kernel-full}"));
